...
namespace AccountsTestP.Api.Migrations
{
    ...
    [Migration("20200312154047_ModifyModel")]
            ...
            modelBuilder.Entity("AccountsTestP.Domain.Models.AccountTypeModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("260bd8b0-dff8-4c50-919f-7a9afbf6a228"),
                            AccountTypeName = "Пассивный счет",
                            AccountTypeNumber = 1,
                            IsActive = false
                        },
                        new
                        {
                            Id = new Guid("cc4c967f-d5a8-43c2-9654-f4fbf20dcbeb"),
                            AccountTypeName = "Активный счет ",
                            AccountTypeNumber = 1,
                            IsActive = true
                        });
                });
